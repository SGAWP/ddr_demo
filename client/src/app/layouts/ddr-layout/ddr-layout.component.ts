...
@Component({
  selector: 'app-ddr-layout',
  templateUrl: './ddr-layout.component.html',
})
export class DDRLayoutComponent implements OnInit, OnDestroy {
  ...
  @HostBinding('class.ddr-content-width-fix') get isContentWidthFix() {
    return (
  ...
  @HostBinding('class.ddr-sidenav-collapsed-fix') get isCollapsedWidthFix() {
    return (
